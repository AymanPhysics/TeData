...
Public Class Invoices6
    ...
    Public TableName As String = "Invoices6"
    ...
    Private Sub BasicForm3_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        'LoadResource()
        bm.Fields = New String() {MainId, MainId2, SubId, "DayDate", "ToBranchId", "IncomeTypeId", "Qty", "Notes"}
        bm.control = New Control() {CboMain, CboMain2, txtID, DayDate, ToBranchId, IncomeTypeId, Qty, Notes}
        ...
        bm.FillCombo(MainTableName, ToBranchId, "")
