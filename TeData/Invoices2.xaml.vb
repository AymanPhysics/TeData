...
Public Class Invoices2
    ...
    Dim TableName As String = "Invoices2"
    ...
    Private Sub BasicForm3_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        'LoadResource()
        bm.Fields = New String() {MainId, MainId2, SubId, "DayDate", "EmpId2", "Value", "Notes"}
        bm.control = New Control() {CboMain, CboMain2, txtID, DayDate, EmpId2, Value, Notes}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnPrint.Click
        If CboMain.SelectedValue.ToString = 0 OrElse CboMain2.SelectedValue.ToString = 0 OrElse EmpId2.Text.Trim = "" OrElse Val(Value.Text.Trim) = 0 Then
            Return
        End If
    ...
    Private Sub EmpId2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles EmpId2.KeyUp
        If bm.ShowHelp("Employees", EmpId2, EmpName2, e, "select cast(Id as varchar(100)) Id,ArName Name from Employees") Then
            EmpId2_LostFocus(Nothing, Nothing)
        End If
    End Sub
    ...
    Private Sub EmpId2_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles EmpId2.LostFocus
        bm.LostFocus(EmpId2, EmpName2, "select ArName Name from Employees where Id=" & EmpId2.Text.Trim())
    End Sub
