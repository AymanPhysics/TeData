...
Public Class Invoices3
    ...
    Public TableName As String = "Invoices3"
    ...
    Private Sub BasicForm3_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        'LoadResource()
        bm.Fields = New String() {MainId, MainId2, SubId, "DayDate", "Value", "Notes"}
        bm.control = New Control() {CboMain, CboMain2, txtID, DayDate, Value, Notes}
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If CboMain.SelectedValue.ToString = 0 OrElse CboMain2.SelectedValue.ToString = 0 OrElse Val(Value.Text.Trim) = 0 Then
            Return
        End If
