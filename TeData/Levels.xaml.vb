    ...
    Sub LoadTree()
        ...
        For i As Integer = 0 To Main.tab.Items.Count - 1
            Try
                ...
                nn.Background = System.Windows.Media.Brushes.Cyan
                nn.SetResourceReference(ComboBoxItem.BackgroundProperty, "BgDelete")
        ...
        For i As Integer = 0 To CType(CType(item.Content, ScrollViewer).Content, WrapPanel).Children.Count - 1
            Try
                ...
                ElseIf TypeOf (item2) Is Label Then
                    ...
                    nn2.SetResourceReference(ComboBoxItem.BackgroundProperty, "BgSave")
                End If
                nn.Items.Add(nn2)
