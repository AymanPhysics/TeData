...
Public Class Login
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnLogin.Click
        ...
        Md.BranchId = dt.Rows(0)("BranchId").ToString
        ...
        Md.IsTeller = IIf(dt.Rows(0)("IsTeller").ToString() = "1", True, False)

        If Md.IsTeller Then
            Dim mm As MainWindow = Application.Current.MainWindow
            mm.StartTeller()
        End If

        Md.Nurse = dt.Rows(0)("Nurse").ToString
        Md.Receptionist = IIf(dt.Rows(0)("Receptionist").ToString() = "1", True, False)
        Md.CustView = IIf(dt.Rows(0)("CustView").ToString() = "1", True, False)
        Md.CustEdit = IIf(dt.Rows(0)("CustEdit").ToString() = "1", True, False)
